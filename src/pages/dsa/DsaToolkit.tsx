...
const topics = [
  { title: "Arrays", path: "/dsa/array/notes.txt" },
  { title: "Strings", path: "/dsa/string/notes.txt" },
  { title: "Heap", path: "/dsa/heap/notes.txt" },
  { title: "Hash Table", path: "/dsa/hashtable/notes.txt" },
  { title: "Linked Lists", path: "/dsa/linked-list/notes.txt" },
  { title: "Stacks", path: "/dsa/stack/notes.txt" },
  { title: "Queues", path: "/dsa/queue/notes.txt" },
  { title: "Trees", path: "/dsa/tree/notes.txt" },
  { title: "Graphs", path: "/dsa/graph/notes.txt" },
  { title: "Segment Tree", path: "/dsa/segment-tree/notes.txt" },
  { title: "Trie", path: "/dsa/trie/notes.txt" },
          ...
          {topics.map((topic, index) => (
            ...
            >
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300 text-sm">
                Download comprehensive notes and examples for {topic.title}.
              </p>
            </a>
          ))}
        </div>
